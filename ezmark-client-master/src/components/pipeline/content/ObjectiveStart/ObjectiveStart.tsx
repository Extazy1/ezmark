...
import { ObjectiveStartProps } from "./interface";

const loadingMessages = [
    "Processing objective questions",
    "Analyzing multiple choice patterns",
    "Reading student responses",
    "Comparing with answer keys",
    "Calculating objective scores",
    "Identifying common misconceptions",
    "Processing true/false questions",
    "Applying AI-assisted grading algorithms"
];

export default function ObjectiveStart({ updateSchedule }: ObjectiveStartProps) {
